...
A regressão por funções de passo ou escada consideram a divisão do domínio do preditor, estimando uma constante para cada divisão. É um modelo que se parece com uma regressão por árvore de decisão para uma variável, porém os algortmos e, portanto, modelos obtidos são completamente distintos.
...
Um problema deste modelo é a descontinuidade e falta de suavidade nas divisões.
