...
Considere um conjunto de dados com três preditores e uma variável independente, com $N = 10$ observações, exibido integralmente a seguir.
...
Considerando as 6 árvores obtidas anteriormente, as previsãos destas para tal observação são: 5.060, 7.028, 6.608, 6.378, 7.210 e 7.036. O modelo *bagging* retorna como resultado a média das previsões das árvores, isto é, $\hat{y} = \frac{1}{6}\sum_{i=b}^6 T(\mathbf{x}_0)$ = 6.55.
