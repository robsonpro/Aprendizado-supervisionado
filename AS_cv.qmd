...
O erro esperado de generalização pode ser calculado como $Err = E[L(y_0,\hat{f}(\mathbf{x}_0, \mathbf{\alpha}))] = E[Err_\mathcal{T}]$.
A forma mais eficiente e prática de estimar o erro esperado de previsão é através da validação cruzada.
...
Mais detalhes podem ser encontrados em \cite{hastie2009elements}.
...
Algumas métricas utilizadas em validação cruzada para quantificar o erro em dados de teste são apresentadas a seguir.
